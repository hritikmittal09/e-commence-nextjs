...
const [heading,setheading] = useState("")
  ...
  return (
    <Box bg="black" py={2}>
      <Flex className=" flex flex-row gap-10" alignItems="center" maxW="6xl" mx="auto">
        <Heading color="white" size="md">
          <img src="data:image/png;base64,"
           alt="" className=" h-10 w-20"/>
        </Heading>
        <div className="">
        <Link href={"/"} className=" text-white ml-20">Home</Link>
        
        <Button className=" bg-yellow-500 text-white"  variant= 'outline'  >
          <Link href= '/auth/signup'>Sign in</Link>
      </Button>
      <Button className=" bg-yellow-500 text-white ml-10"  variant= 'outline'  >
      <Link href= '/auth/login'>Log in</Link>
      </Button>
      </div>

      <Button className="  bg-green-500 mx-10 text-white"  variant= 'outline' >
          <Link href= '/'>Add Product</Link>
      </Button>
    
        <Spacer/>
       <button className=" bg-black justify-end items-end  rounded-full"> <LuShoppingCart  className="  text-4xl text-white cursor-pointer "/></button>
